...
function MyStack() {
  ...
  return (
    <Stack.Navigator initialRouteName="SplashScreen" headerMode="none">
      {!loginStatus && <Stack.Screen  name="SplashScreen" component={SplashScreen}/>}
      {!loginStatus && <Stack.Screen name="Intro" component={Intro} />}
      {!loginStatus && <Stack.Screen name="Login" component={Login} />}
      {!loginStatus &&<Stack.Screen name="Registration" component={Registration} />}
      {!loginStatus &&<Stack.Screen name="ForgetPass" component={ForgetPass} />}
